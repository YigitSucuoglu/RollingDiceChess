...
`generated/slot-machine-frame.png` eski üretim varyantıdır ve mevcut production registry tarafından import edilmez.

`generated/pawn.png`, `knight.png`, `bishop.png`, `rook.png`, `queen.png` ve `king.png` eski sembol varyantlarıdır ve mevcut Piece Set resolver tarafından kullanılmaz.

`generated/slot-machine-lever.png` eski üretim varyantıdır ve mevcut production registry tarafından import edilmez.
